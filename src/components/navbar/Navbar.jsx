  ...
  return (
    <header className="bg-[#F5F4F2] h-20">
      <div className="container">
        <div className="grid grid-cols-2 md:grid-cols-[200px_1fr_125px] lg:grid-cols-[1fr_2fr_1fr] gap-4 lg:gap-6 justify-between py-3 border-b border-[#8a878466] relative">
          ...
          <div className="hidden md:flex justify-center gap-3 lg:gap-6">
          ...
          <div className={`${openDropdown ? "flex" : "hidden"} flex-col justify-center gap-6 bg-white shadow-lg absolute top-[73px] right-0 p-6 rounded-lg`}>
            <div className="flex items-center gap-2 px-3 rounded-2xl border-2 border-[#8a878466]  bg-white">
              <IoSearch className="text-xl lg:text-3xl text-gray-400" />
              <input
                className="py-2 lg:py-3 outline-none border-none"
                type="text"
                placeholder="Find in Helios"
              />
            </div>
            ...
            <div className="flex items-center gap-2 px-3 rounded-2xl border-2 border-[#8a878466]  bg-white">
              <IoIosSend className="text-xl lg:text-3xl" />
              <input
                className="py-2 lg:py-3 outline-none border-none placeholder:text-black placeholder:font-semibold"
                type="text"
                placeholder="Enter delivery address"
              />
            </div>
          ...
          <span onClick={() => setOpenDropdown(!openDropdown)} className="text-3xl md:hidden"><IoMenu /></span>
          </div>
        </div>
      </div>
    </header>
